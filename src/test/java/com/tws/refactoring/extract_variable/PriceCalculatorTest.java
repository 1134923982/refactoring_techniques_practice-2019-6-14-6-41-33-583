...
public class PriceCalculatorTest {
    @Test
    public void should_return_550_when_give_10_and_50(){
    ...
    @Test
    public void should_return_25100_when_give_500_and_50(){
        PriceCalculator priceCalculator = new PriceCalculator();
        double price = priceCalculator.getPrice(500,50);
        Assert.assertEquals(25100.0,price,0);
    }
    @Test
    public void should_return_25147_when_give_501_and_50(){
        PriceCalculator priceCalculator = new PriceCalculator();
    ...
    @Test
    public void should_return_1100_when_give_100_and_10(){
        PriceCalculator priceCalculator = new PriceCalculator();
    ...
    @Test
    public void should_return_1110_when_give_101_and_10(){
        PriceCalculator priceCalculator = new PriceCalculator();
